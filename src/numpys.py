...
print(f"np_array[2] : {np_array}, type(np_array[2]), :  {type(np_array[2])}")  # np_array[2] : [1 2 3 4 5], type(np_array[2]), :  <class 'numpy.int64'>
...
print(type(np_mdarray[2][2]))  # <class 'numpy.str_'> why not int64 ? because of "Hello" string value in the array 
