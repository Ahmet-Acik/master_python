...
emails = ["abc@gmail.com", "def@gmail.com", "ghf@gmail.com", "abc@gmail.com", "xyz@gmail.com"]
...
print(f"my_fruits_set after popping: {my_fruits_set}") # Output: my_fruits_set after popping: {'apple', 'cherry', 'orange', 'melon', 'strawberry'}
