...
nested_list = [[1, 2, 3], [4, 5, 6], [7, 8, 9]]
squares_of_even_numbers = [num ** 2 for sublist in nested_list for num in sublist if num % 2 == 0]
...
print(multiplication_table)  # Output: [(1, 1, 1), (1, 2, 2), (1, 3, 3), (2, 1, 2), (2, 2, 4), (2, 3, 6), (3, 1, 3), (3, 2, 6), (3, 3, 9)]
...
print(names_and_cities)  # Output: [('Alice', 'New York'), ('Bob', 'Los Angeles'), ('Charlie', 'Chicago')]


### Example 14: Filtering and Flattening Nested Lists of Strings
nested_list = [["apple", "banana"], ["cherry", "date"], ["fig", "grape"]]
filtered_fruits = [fruit for sublist in nested_list for fruit in sublist if len(fruit) > 5]
print(filtered_fruits)  # Output: ['banana', 'cherry']


### Example 15: Creating a List of Indices of Even Numbers in Nested Lists
nested_list = [[1, 2, 3], [4, 5, 6], [7, 8, 9]]
even_indices = [(i, j) for i, sublist in enumerate(nested_list) for j, num in enumerate(sublist) if num % 2 == 0]
...
names_older_than_30 = [info["name"] for group, info in nested_dict.items() if info["age"] > 30]
...
filtered_transformed = [(x * 2, y * 2) for sublist in nested_tuples for x, y in sublist if x % 2 != 0]
...
def filter_and_transform_tuples(nested_tuples):
    ...
    """
    return [(x * 2, y * 2) for sublist in nested_tuples if isinstance(sublist, list) for x, y in sublist if isinstance((x, y), tuple) and x % 2 != 0]
...
def find_even_indices(nested_list):
    return [(i, j) for i, sublist in enumerate(nested_list) for j, num in enumerate(sublist) if num % 2 == 0]
...
# Example 17: Filtering and Transforming Nested Lists of Tuples
def filter_and_transform_tuples(nested_tuples):
    return [(x * 2, y * 2) for sublist in nested_tuples for x, y in sublist if x % 2 != 0]
...
if __name__ == "__main__":
    ...
    # Example 2
    print("Flattened and filtered even numbers:", flatten_and_filter_even_numbers(nested_list))
    ...
    print("Names of people older than 30:", extract_values_by_condition(data, "name", lambda d: d["age"] > 30))
    ...
    print("Filtered and transformed tuples:", filter_and_transform_tuples(nested_tuples))
...
# Main method to call the functions
    ...
    print("Names and cities:", extract_names_and_cities(data))  # Output: [('Alice', 'New York'), ('Bob', 'Los Angeles'), ('Charlie', 'Chicago')]

    # Example 14
    nested_list = [["apple", "banana"], ["cherry", "date"], ["fig", "grape"]]
    print("Filtered fruits:", filter_fruits(nested_list))  # Output: ['banana', 'cherry']

    # Example 15
    nested_list = [[1, 2, 3], [4, 5, 6], [7, 8, 9]]
    print("Even indices:", find_even_indices(nested_list))  # Output: [(0, 1), (1, 0), (1, 2), (2, 1)]
    ...
    print("Names older than 30:", extract_names_older_than_30(nested_dict))  # Output: ['Charlie']
    ...
    print("Names from nested dicts:", extract_names_from_nested_dicts(nested_list_of_dicts))  # Output: ['Alice', 'Bob', 'Charlie', 'David']

    # Example 19
    nested_list = [[1, 2, 3], [4, 5, 6], [7, 8, 9]]
    print("Filtered sublists by sum:", filter_sublists_by_sum(nested_list))  # Output: [[7, 8, 9]]

    # Example 20
    list1 = [1, 2, 3]
    list2 = [4, 5, 6]
    print("Pairs with sum greater than 7:", find_pairs_with_sum_greater_than_7(list1, list2))  # Output: [(2, 6), (3, 5), (3, 6)]
