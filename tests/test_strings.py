...
from strings import (
    get_character_in_name, get_substring, get_quote_slices, get_learning_fun_slices,
    reverse_string, concatenate_names, repeat_string, format_string, string_methods
)
...
class TestStrings(unittest.TestCase):
    ...
    def test_get_quote_slices(self):
        ...
        self.assertEqual(slices["slice_2_step"], "Tegets lr nlvn isnti ee aln,bti iigeeytm efl.")
    ...
    def test_repeat_string(self):
        self.assertEqual(repeat_string("Ahmet Oglu", 3), "Ahmet OgluAhmet OgluAhmet Oglu")
    ...
    def test_format_string(self):
        ...
        self.assertEqual(formatted["f_string"], "My name is Ahmet and I am 40 years old.")
    ...
    def test_string_methods(self):
        ...
        self.assertEqual(methods["encode_utf_32"], b'\xff\xfe\x00\x00A\x00\x00\x00h\x00\x00\x00m\x00\x00\x00e\x00\x00\x00t\x00\x00\x00')
